...
class PathAnimation{
    ...
    genRandomCatmullRomBalls(){
        ...
        // const crs = this.genRandomCatmullRom();
        // const cnt = 10;
        // const step = 1 / cnt;
        // crs.map(cr=>{
        //     for(let t=0; t <= 1; t += step){
        //         console.log('t: ', t, ' cr(t): ', cr(t));
        //         const pos = cr(t);
        //         this.createBall({pos});
        //     }
        // });
    ...
    movePt(){
        if(this.pt){
            ...
            let pos = this.pt.pos();
            if( !this.ptBall ){
                this.ptBall = this.createBall({pos});
            }
            this.ptBall.position.set(pos.x, pos.y, pos.z);
    ...
    drawLine(v0, v1=new THREE.Vector3(0,0,0)){
